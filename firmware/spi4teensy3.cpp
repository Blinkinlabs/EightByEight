...
namespace spi4teensy3 {
        ...
        void init() {
                ...
                CORE_PIN11_CONFIG = PORT_PCR_DSE | PORT_PCR_MUX(2);     // SCK
                CORE_PIN12_CONFIG = PORT_PCR_DSE | PORT_PCR_MUX(2);     // MOSI
                CORE_PIN13_CONFIG = PORT_PCR_MUX(2);                    // MISO
                CORE_PIN8_CONFIG = PORT_PCR_DSE | PORT_PCR_MUX(2);      // CS
